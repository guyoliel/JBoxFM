...
public class SimpleRequestAdapter extends ArrayAdapter<Request> {
    ...
    public SimpleRequestAdapter(Context ctx, List<Request> itemList) {
        super(ctx, R.layout.request_list_item, itemList);
        this.ctx = ctx;
        Log.i(TAG,"hi c");
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.request_list_item,parent,false);
